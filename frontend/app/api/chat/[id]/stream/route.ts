...
} from "@/features/ai/chat/services";
import type { Chat } from "@/features/ai/chat/types/db.types";
...
export async function GET(
  ...
  if (chat.visibility === "private" && (chat as any).userId !== user.id) {
  ...
  if (!stream) {
    ...
    const messageCreatedAt = new Date(mostRecentMessage.created_at as unknown as string);
