module.exports=[155584,a=>{"use strict";a.s(["encodeIntoResult",()=>i,"stegaEncodeSourceMap",()=>q,"stegaEncodeSourceMap$1",()=>r]);var b=a.i(544751);let c=/_key\s*==\s*['"](.*)['"]/;function d(a){if(!Array.isArray(a))throw Error("Path is not an array");return a.reduce((a,b,d)=>{let e=typeof b;if("number"===e)return`${a}[${b}]`;if("string"===e)return`${a}${0===d?"":"."}${b}`;if(("string"==typeof b?c.test(b.trim()):"object"==typeof b&&"_key"in b)&&b._key)return`${a}[_key=="${b._key}"]`;if(Array.isArray(b)){let[c,d]=b;return`${a}[${c}:${d}]`}throw Error(`Unsupported path segment \`${JSON.stringify(b)}\``)},"")}let e={"\f":"\\f","\n":"\\n","\r":"\\r","	":"\\t","'":"\\'","\\":"\\\\"},f={"\\f":"\f","\\n":`
