...
import { type ArtifactKind, artifactDefinitions } from "@/features/ai/chat/components/artifact/artifact";
import type { ArtifactToolbarItem } from "@/features/ai/chat/components/artifact/create-artifact";
import { ArrowUpIcon, StopIcon, SummarizeIcon } from "../core/icons";
        ...
        {isToolbarVisible &&
          secondaryTools.map((secondaryTool) => (
            <Tool
              ...
              onClick={({ sendMessage }) => {
                const context = { sendMessage: sendMessage as any };
                secondaryTool.onClick(context);
              }}
...
const PureToolbar = ({
  ...
  useOnClickOutside(
    toolbarRef as React.RefObject<HTMLElement>,
    () => {
